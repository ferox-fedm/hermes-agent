...
_WINDOWS_BASH_SHELL_HINT = (
    ...
    "read. Tool ↔ path format: ONLY the `terminal` tool accepts MSYS paths "
    "(`/c/...`, `/g/...`, `/h/...`). All other tools (`read_file`, "
    "`write_file`, `patch`, `edit_file`, `execute_code`, `vision_analyze`, "
    "`search_files`, etc.) run in Python/Node and require Windows-style "
    "paths (`C:/Users/<user>/...`); using `/g/...` with them fails with "
    "`FileNotFoundError`. When answering prompts in a "
