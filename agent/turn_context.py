...
def build_turn_context(
    ...
    *,
    ...
    # Clear text output dedup history on new user turn so cross-turn
    # loop detection starts fresh with the new user input.
    if hasattr(agent, '_text_output_guardrails'):
        agent._text_output_guardrails.on_user_input_or_progress()
